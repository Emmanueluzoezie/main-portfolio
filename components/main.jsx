...
export default function Main() {
    ...
    return (
        <section className="dark:bg-gray-800 bg-gray-100 grid place-items-center h-4/6 md:h-4/6 mb-32">
            <div className="mb-0 w-5/6 h-4/6 md:w-full text-center md:text-left flex md:mx-10 flex-col md:grid md:grid-cols-2 lg:px-40 md:px-10 ">
               ...
               <div className="w-full"> 
                ...
                <Link href="https://emmanueluzoezie.bio.link/" passHref><button className="w-36 text-xl border-2 mt-4 py-3 bg-blue-500 dark:bg-gray-700 text-white hover:bg-white hover:text-black rounded-xl font-bold font-mono hover:transform hover:ease-in-out border-none hover:duration-700">CONTACT ME</button></Link>
                </div>
               </div>
